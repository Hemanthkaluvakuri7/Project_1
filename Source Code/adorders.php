...
#if(isset($_POST["ts2"]))
{
    #if($_POST["ts2"])
    {
        ...
        $user = 'root';
            ...
            $SQLstring1 = "SELECT * FROM $tableName t1 join $tableName2 t2 on t1.c_id=t2.c_id order by o_id ";
            ...
            while ($row = $result->fetch_assoc()) {
             ...
             if($de > date("Y-m-d"))
             {
              echo "<form method='post'><input type='submit' name =cb value='Cancel Booking'></form><br><hr>";
             }
             else{
               echo "<hr>";
             }
...
<input type='submit' name ='ts2' class="button button1" value='Go To Home as Normal user'>
    </form>
    </center>
</body>
    </html>
