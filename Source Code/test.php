...
if(isset($_POST["signUP"]))
{
    if($_POST["signUP"])
    {
        ...
        function phone()
        {
            ...
            $SQLstring = "INSERT INTO $tableName VALUES( NULL, '".$name."','".$password."','".$email."','".$phone."','".$zipcode."',0)";


              if ($mysqli->query($SQLstring) === TRUE) {
               header("Location: http://localhost/index.html");
             } else {
  echo "Error: " . $SQLstring . "<br>" . $mysqli->error;
}
...
<br>
        <center>
            <font color=#cc4151>  Username: <input type="text" placeholder="Enter Username" name="user" required>
                ...
                Mobile No: <input type="tel" placeholder="Enter phone number" pattern="[0-9]*"  name="pho" minlength="10" required>
                <br><br>
                Zipcode : <input id="zip" placeholder="Enter Zipcode" name="zip" maxlength="5" pattern="[0-9]*" minlength="5" required>
                <br><br>
